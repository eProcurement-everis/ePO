...
In order to develop these global deliverables the following Governance Structure, the following roles and responsibilities were established:
...
=== Main Objective of the ePO v2.0.0
